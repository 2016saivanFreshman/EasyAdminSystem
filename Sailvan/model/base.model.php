...
class BaseModel{
	...
	///////////////////2016-7-27这里需要细看
	protected function select($source=array('mysql'), $cachetime=900){			// get_promptmsg函数在prompt_msg表中不存在数据，则会引起死循环（递归函数的递归调用所引起） By JBF
		//trim移除字符串左侧的空白字符，或其他自定义的字符
		//intval函数可将变量转成整数类型
